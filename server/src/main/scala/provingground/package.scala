...
package object provingground {
  ...
  implicit val twirlHtmlMarshaller
    : akka.http.scaladsl.marshalling.ToEntityMarshaller[play.twirl.api.Html] =
    twirlMarshaller[Html](`text/html`)
  implicit val twirlTxtMarshaller
    : akka.http.scaladsl.marshalling.ToEntityMarshaller[play.twirl.api.Txt] =
    twirlMarshaller[Txt](`text/plain`)
  implicit val twirlXmlMarshaller
    : akka.http.scaladsl.marshalling.ToEntityMarshaller[play.twirl.api.Xml] =
